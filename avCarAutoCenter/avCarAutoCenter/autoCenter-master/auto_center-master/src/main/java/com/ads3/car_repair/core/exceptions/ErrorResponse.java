...
public class ErrorResponse {
    ...
    public static ErrorResponse error(com.ads3.car_repair.core.exceptions.FieldValidationException ex) {
    	return new ErrorResponse(ex.getTitle(), ex.getMessage().concat(" -> ").concat(ex.getMotive()));
    }
    public static  ErrorResponse error(com.ads3.car_repair.core.exceptions.RuleValidationException ex) {
    	return new ErrorResponse(ex.getTitle(), ex.getMessage().concat(" -> ").concat(ex.getMotive()));
    }
